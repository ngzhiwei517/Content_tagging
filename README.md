...
Checkpoints are local by default. Google Cloud Storage, Supabase, or Postgres can optionally provide recovery after an app restart or redeployment. Checkpoints never contain provider credentials or downloaded media. See [Persistent checkpoints](docs/PERSISTENT_CHECKPOINTS.md).
