...
v68.10 is the current test release and is integrated end to end.

## Current product direction
- Use the v68.10 implementation and its v41-style UI flow as the baseline unless the user explicitly says otherwise.
...
## UI rules
- Keep the v68.10 UI and v41-style flow unless told otherwise.
