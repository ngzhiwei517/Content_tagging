...
| `ugc_tagger/tagging_worker_queue.py` | Global single-worker admission with a local development fallback | Tagging concurrency or queue behavior needs to change |
