...
```text
Read AGENTS.md and docs/PROJECT_CONTEXT.md first. Do not edit code yet. Summarize the current v68.10 architecture, accepted UI baseline and safest next change.
```
