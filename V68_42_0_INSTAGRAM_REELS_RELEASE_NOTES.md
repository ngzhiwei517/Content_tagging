...
- Missing Instagram shares/saves and their rates display as `Not available`
  instead of a misleading zero; TikTok's genuine zero values remain zero.
...
- When shares or saves are unavailable, total engagement and engagement rate
  use only the metrics returned by Instagram and should be treated as partial.
